...
$temp = $_SESSION['TituloProvisionalP'];
    ...
    <div class="contenedor-NoticiaScroll">
        <div class ="grupo-Noticia">  
            ...
            <div class="Datos-Noticia">
                ...
                <h1> <?php echo$_SESSION['titulasop']?></h1>              
                <br>
       ...
       case 'Editor':
        ...
        include ('./ComentarioAdmin.php');
         ...
         case 'Reportero':
          ...
          <button  action = "Pagina_ModificarNoticia.php" method = "Post" class="buttonNoticiaEsh">Modificar Nota</button> 
          </form> 
          
            <form action="Pagina_ModificarNotiImagen.php" method="POST" id="form"> 
            <input type="hidden" name="num2" id="num2" value = <?php echo$_SESSION['numeroref']?>>
            <button  action = "Pagina_ModificarNoticia.php" method = "Post" class="buttonNoticiaEsh">Modificar Imagenes</button> 
            </form> 
            <?php
           break;
